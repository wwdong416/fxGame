...
<div>
  ...
  <el-container class="user_info t_a_c">
    ...
    <el-main>
      <div class="flexbox" >
        <div class="fl sq" @click="getBonus(1)" style="color: #f95f02;font-weight: bold">$100赛区</div>
        <div class="fl sq" @click="getBonus(2)">$500赛区</div>
        <div class="fl sq" @click="getBonus(3)">$1000赛区</div>
        <div class="clear"></div>
      </div>
  ...
  <el-container class="user_info t_a_c">
    ...
    <el-main>
      ...
      <div class="fl w21 mt40" style="text-align: left;line-height: 1.8">
        获奖举例：<br>
  ...
  <el-container class="user_info">
    ...
    <div style="background-color:#414141;"><div class="footer_warn">
      风险警示：<br>
